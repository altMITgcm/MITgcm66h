...
cph suspect a bug in adjoint for this flag...
# define  ALLOW_READ_EGM_DATA
C       >>> Use NSCAT data.
...
#define ALLOW_CURMTR_COST_CONTRIBUTION
# undef ALLOW_XBT_COST_CONTRIBUTION
# undef ALLOW_COST_ATLANTIC
#undef ALLOW_SUBEXT_COST_CONTRIBUTION
#undef ALLOW_SUBEXUV_COST_CONTRIBUTION
#define SUBEX_2DEG
...
# endif
c       >>> New O.B. components of the cost function.
#undef OBCS_VOLFLUX_COST_CONTRIBUTION
#define OBCS_AGEOS_COST_CONTRIBUTION
c       >>> Options for weights.
#define COST_WEIGHTS_EDDY_NOISE
#undef COST_WEIGHTS_2X_EDDY_NOISE
#undef COST_WEIGHTS_EDDY_RESOLVE
#define NONDIAG_WEIGHTS
#endif /* ALLOW_COST */
...
#endif
#undef NO_CONTROL_BAROTROPIC_VELOCITY
